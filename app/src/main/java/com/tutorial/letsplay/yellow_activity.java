...
public class yellow_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn3 = findViewById(R.id.button56);

        btn1.setOnClickListener (new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), red_activity.class);
        ...
        btn2.setOnClickListener (new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v){
                Intent intent = new Intent(getApplicationContext(), green_activity.class);
                startActivity(intent);
            }
